...
void display0(void)
{
	...
	bitmap_output(-21, 40, "      M S ENGINEERING COLLEGE", GLUT_BITMAP_TIMES_ROMAN_24);
	...
	bitmap_output(-15, -25, "ANIKET GAURAV                1ME19CS006", GLUT_BITMAP_HELVETICA_18);
	bitmap_output(-15, -30, "OJASH PRASAD                 1ME19CS060", GLUT_BITMAP_HELVETICA_18);
...
void tution3()
{
	...
	glVertex3f(-14, 8, 0);
	glEnd();
	//alpha residency window left top
	glColor3f(0.4, 0.4, 0.4);
	glVertex3f(-14, 16, 0);
	glVertex3f(-6, 16, 0);
	glVertex3f(-6, 24, 0);
